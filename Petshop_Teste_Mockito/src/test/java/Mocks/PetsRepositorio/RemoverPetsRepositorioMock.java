...
public class RemoverPetsRepositorioMock {
    ...
    private Cliente cliente = new Cliente("Matheus", "66666666655", "85990324354");
    ...
    @Test
    public void removerPetsValido() throws SQLException {
        ...
        petsController.removerPet(pet1);
